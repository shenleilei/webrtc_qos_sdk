...
export BITRATE
export FRAMES
export MIN_RECONFIGS_WALKING="${MIN_RECONFIGS_WALKING:-8}"
export MIN_RECONFIGS_BANDWIDTH="${MIN_RECONFIGS_BANDWIDTH:-6}"
export MIN_RECONFIGS_JITTER="${MIN_RECONFIGS_JITTER:-4}"
