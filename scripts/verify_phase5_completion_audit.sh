...
require_script verify_webrtc_first_qoe_production_soak_evidence.sh production_soak_evidence_gate
...
require_doc_pattern scripts/verify_webrtc_first_qoe_production_soak_evidence.sh \
  'production_soak_evidence_verification=true' production_soak_evidence_verifier
require_doc_pattern scripts/verify_webrtc_first_qoe_production_soak_evidence.sh \
  'production soak summary mismatch for' production_soak_evidence_summary_csv_gate
require_doc_pattern scripts/verify_webrtc_first_qoe_production_soak_evidence.sh \
  'production soak SOAK_MINUTES below minimum' production_soak_evidence_min_soak_gate
require_doc_pattern scripts/verify_webrtc_first_phase2_completion_audit.sh \
  'verify_webrtc_first_qoe_production_soak_evidence.sh' production_gate_phase2_soak_evidence_reverify
require_doc_pattern scripts/import_phase5_phase2_evidence_bundle.sh \
  'production_soak_evidence' production_gate_external_import_soak_evidence_gate
require_doc_pattern scripts/verify_phase5_production_readiness.sh \
  'production_soak_evidence_log' production_readiness_external_soak_evidence_log_gate
require_doc_pattern scripts/verify_phase5_production_gate.sh \
