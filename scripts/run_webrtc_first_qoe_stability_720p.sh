...
OUTPUT_DIR="${OUTPUT_DIR:-${SDK_ROOT}/artifacts/webrtc_first_qoe_stability_720p}"
...
MIN_PLAYABLE_RATIO="${MIN_PLAYABLE_RATIO:-0.85}"
...
SCENARIOS="${SCENARIOS:-baseline bandwidth_cliff_recover weak_network_low_rps_low_bitrate sustained_low_bandwidth_low_rps weak_start_low_bandwidth_low_rps walking_dead_zone_recover}"
...
OUTPUT_BASENAME="webrtc_first_qoe_stability_720p" \
FRAMES="${FRAMES}" \
WIDTH="${WIDTH}" \
HEIGHT="${HEIGHT}" \
