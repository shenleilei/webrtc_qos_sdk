...
# Create imported target WebRtcQosSdk::webrtc_qos
add_library(WebRtcQosSdk::webrtc_qos STATIC IMPORTED)

set_target_properties(WebRtcQosSdk::webrtc_qos PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
)

# Create imported target WebRtcQosSdk::webrtc_qos_core
add_library(WebRtcQosSdk::webrtc_qos_core STATIC IMPORTED)
