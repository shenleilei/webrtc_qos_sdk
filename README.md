...
- P5 默认按无显卡/无真实生产素材环境执行：`P5_SKIP_REAL_RENDERER=1` 和 `P5_SKIP_CAPTURE_LIBRARY=1` 会记录显式 policy skip 证据；仍要求 `SOAK_MINUTES>=120` 的 production soak。若要做严格实机/业务素材验收，把这两个变量设为 `0`。
